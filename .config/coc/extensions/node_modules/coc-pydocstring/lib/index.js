...
var require_tmp = __commonJS({
  "node_modules/tmp/lib/tmp.js"(exports, module2) {
    ...
    function _prepareTmpDirRemoveCallback(name, opts, sync) {
      const removeFunction = opts.unsafeCleanup ? rimraf2 : fs4.rmdir.bind(fs4);
...
function activate(context, outputChannel) {
  ...
  context.subscriptions.push(import_coc.languages.registerCodeActionProvider(documentSelector, new DoqCodeActionProvider(outputChannel), "pydocstring"));
}
var DoqCodeActionProvider = class {
  ...
  async provideCodeActions(document, range, context) {
    ...
    if (this.lineRange(range) || this.selectedRange(doc, range)) {
      ...
      const resolveRange = import_coc.Range.create({ line: range.start.line, character: 0 }, { line: resolveEndRangeLine, character: resolveEndRangeChara });
...
async function doqInstall(pythonCommand, context) {
  const pathVenv = import_path.default.join(context.storagePath, "doq", "venv");
  let pathVenvPython = import_path.default.join(context.storagePath, "doq", "venv", "bin", "python");
  if (process.platform === "win32") {
    pathVenvPython = import_path.default.join(context.storagePath, "doq", "venv", "Scripts", "python");
  }
...
function activate2(context, builtinInstallPythonCommand) {
  ...
  context.subscriptions.push(import_coc3.commands.registerCommand("pydocstring.install", async () => {
...
function getDoqPath(context) {
  ...
  if (!doqPath) {
    ...
    if (whichDoq) {
      doqPath = whichDoq;
    } else if (import_fs.default.existsSync(import_path2.default.join(context.storagePath, "doq", "venv", "Scripts", "doq.exe")) || import_fs.default.existsSync(import_path2.default.join(context.storagePath, "doq", "venv", "bin", "doq"))) {
      if (process.platform === "win32") {
        doqPath = import_path2.default.join(context.storagePath, "doq", "venv", "Scripts", "doq.exe");
      } else {
        doqPath = import_path2.default.join(context.storagePath, "doq", "venv", "bin", "doq");
      }
    }
  }
  return doqPath;
...
function getPythonCommand(isRealpath) {
  ...
  try {
    ...
    if (isRealpath) {
      res = import_fs.default.realpathSync(res);
    }
    return res;
  } catch (e) {
  }
...
async function doFormat(context, outputChannel, document, range) {
  ...
  const args = [];
  const opts = { cwd: import_path3.default.dirname(fileName) };
  args.push("-w");
  args.push("--formatter", formatterOption);
  if (templatePath && import_fs2.default.existsSync(templatePath) && import_fs2.default.existsSync(import_path3.default.join(templatePath, "class.txt")) && import_fs2.default.existsSync(import_path3.default.join(templatePath, "def.txt")) && import_fs2.default.existsSync(import_path3.default.join(templatePath, "noarg.txt"))) {
...
`);
  return new Promise(function(resolve) {
    import_child_process2.default.execFile(doqPath, [...args, tmpFile.name], opts, function(err) {
      ...
      const text2 = import_fs2.default.readFileSync(tmpFile.name, "utf-8");
      tmpFile.removeCallback();
...
function activate3(context, outputChannel) {
  context.subscriptions.push(import_coc6.commands.registerCommand("pydocstring.runAction", async (document, range) => {
...
function activate4(context, outputChannel) {
  context.subscriptions.push(import_coc7.commands.registerCommand("pydocstring.runFile", async () => {
...
function activate5(context, outputChannel) {
  context.subscriptions.push(import_coc8.commands.registerCommand("pydocstring.showOutput", () => {
    outputChannel.show();
  }));
}
